...
public class ReserveParkingSpotAndManageMyParkingSpot extends SeleniumTestBase{
	...
	@Test
	@FileParameters("./seleniumTestData/ReserveParkingSpotToManageTestData.csv")
	public void aReserveParkingToManage(int testno, String parkingarea_name, String parkingtype, 
	...
	public void bReserveParkingWithoutOptionsModifyMyReservTest(int testno, String parkingarea_name, String parkingtype, 
		...
		driver.findElement(By.xpath(prop.getProperty("StudentFaculty_cancelReservation_link"))).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.id(prop.getProperty("ConfirmmodifyReservation_modifymyreservation_btn"))).click();
		...
		if(error.equals("")) {
			...
			driver.findElement(By.id(prop.getProperty("ConfirmmodifyReservation_cancelmyreservation_btn"))).click();
	...
	private static void registerAndLogin() throws InterruptedException {
		User user = new User("Brocoline", "manageMyReserv", "brocolinemy", "Test@123", "Test@123", "1001518112", "Student/Faculty",
		...
		loginTestFunctions.loginSuccessFunction("brocolinemy", "Test@123");
